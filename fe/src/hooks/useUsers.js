...
export const useUpdateUser = () => {
  ...
  return useMutation({
    mutationFn: ({ employeeCode, data }) => userService.updateUser(employeeCode, data),
    onSuccess: (_, variables) => {
      queryClient.invalidateQueries({ queryKey: ['users'] })
      queryClient.invalidateQueries({ queryKey: ['users', variables.employeeCode] })
...
export const useBulkUpdateUsers = () => {
  ...
  return useMutation({
    mutationFn: ({ employeeIds, data }) => userService.bulkUpdateUsers(employeeIds, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['users'] })
