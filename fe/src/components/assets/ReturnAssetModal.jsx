...
export function ReturnAssetModal({ isOpen, onClose, asset }) {
  ...
  return (
    <Modal
      ...
      description={`Thu hồi ${asset.product_name} từ ${asset.current_user_employee_code || 'người dùng'}`}
      className="max-w-md"
    >
      <div className="space-y-4">
        ...
        <div className="bg-muted p-3 rounded-lg">
          ...
          <p className="text-sm"><strong>Người dùng hiện tại:</strong> {asset.current_user_employee_code || '-'}</p>
        </div>

        {/* Select Department */}
        <div>
          <label className="block text-sm font-medium mb-1">Bộ phận lưu giữ</label>
          <Select
        ...
        {/* Notes */}
        <div>
          <label className="block text-sm font-medium mb-1">Ghi chú thu hồi</label>
          <textarea
            value={notes}
