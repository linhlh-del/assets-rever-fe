...
const menuItems = [
  ...
  { label: "Người dùng", icon: Users, path: "/users", roles: MANAGEMENT_ROLES },
  { label: "Tài sản", icon: Package, path: "/assets", roles: ALL_ROLES },
  {
    label: "Hóa đơn",
    icon: FileText,
    path: "/invoices",
  ...
  { label: "Bảo trì", icon: Wrench, path: "/maintenance", roles: ALL_ROLES },
  {
